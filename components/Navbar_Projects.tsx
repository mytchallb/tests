...
const Navbar = () => {
    ...
    return (
      <header className='w-full flex justify-between p-4 mb-8 items-center bg-black'>
        ...
        <div
          className={
            nav
              ? 'ease-in duration-300 fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/90 px-4 flex-col z-10'
